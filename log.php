                    ...
                    <div class="container">
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                <div>
                                    <h2 class="text-white pb-2 fw-bold">SMP NEGERI 3 TJ.PURA</h2>
                                    <!-- <h5 class="text-white op-7 mb-2">Absen Lebih mudah gunakan Aplikasi Absensi</h5> -->
                                </div>
                                <div class="ml-md-auto py-2 py-md-0">
                                    <a href="#" class="btn btn-white btn-border btn-round mr-2">Jln.terusan No.148 Tanjung Pura Kec. Tanjung Pura Kab. Langkat Kode Pos 20853
	<br>Email : smpn3tanjungpura@gmail.com Telp.081222333444</a>

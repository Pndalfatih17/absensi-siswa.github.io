        ...
        <div class="main-header" style="background-color: #1269DB;">
            ...
            <div class="container">
                <div class="logo-header" data-background-color="blue2">
                    ...
                    <a href="index.php">
                        <img src="assets/img/tut.png" alt="navbar brand" class="navbar-brand" width="40">
    ...
    <footer class="footer">
        <div class="container">
            <div class="copyright ml-auto">
                &copy; <?php echo date('Y');?> Absensi Siswa SMP Negeri 3 Tj.Pura (<a href="index.php">Pandu Al Fatih </a>
                | 2022)
            </div>
        </div>
    </footer>
